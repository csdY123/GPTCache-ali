...
class SearchDistanceEvaluation(SimilarityEvaluation):
    ...
    def evaluation(
        ...
        """Evaluate the similarity score of pair.   评估配对的相似度得分。
        :param src_dict: the query dictionary to evaluate with cache. 使用缓存评估的查询字典。
        :type src_dict: Dict
        :param cache_dict: the cache dictionary. 缓存字典
